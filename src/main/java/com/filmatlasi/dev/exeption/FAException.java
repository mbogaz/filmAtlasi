...
//film atlasi exception

import com.filmatlasi.dev.config.MessagesPropertiesConfig;
...
@Component
public class FAException {

    private static MessagesPropertiesConfig messagesPropertiesConfig;

    @Autowired
    public FAException(MessagesPropertiesConfig MessagesPropertiesConfig) {
        this.messagesPropertiesConfig = MessagesPropertiesConfig;
    }
    ...
    private static String format(String template, String... args) {
        Optional<String> templateContent = Optional.ofNullable(messagesPropertiesConfig.getConfigValue(template));
